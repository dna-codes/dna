...
describe('markdown — product-ui section', () => {
    const md = (0, index_1.render)({ productUi: ui }, { sections: ['product-ui'], title: 'Store' });
    ...
    it('renders nothing when productUi is absent', () => {
        const empty = (0, index_1.render)({ productUi: undefined }, { sections: ['product-ui'] });
        expect(empty).toBe('');
    });
});
//# sourceMappingURL=product-ui.test.js.map