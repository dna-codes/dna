...
exports.stripIdSuffix = stripIdSuffix;
exports.operationMutationName = operationMutationName;
/** Convert `snake_case_name` to `camelCaseName`. Idempotent for already-camel names. */
function snakeToCamel(name) {
    return name.replace(/_([a-zA-Z0-9])/g, (_, ch) => ch.toUpperCase());
}
 ...
 */
function stripIdSuffix(attribute) {
 ...
 */
function operationMutationName(target, action) {
