...
export default function Page() {
  ...
  return (
    <LensShell exampleLabel={fixture.name} lensLabel="Responsibility Map" exampleId="audiobook-distributor" lensId="responsibility-map" theme={fixture.theme}>
      <div className="canvas-wrap">
        <ResponsibilityMapCanvas graphData={graphData} theme={fixture.theme} />
      </div>
