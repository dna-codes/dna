...
export default function Page() {
  ...
  return (
    <LensShell exampleLabel={fixture.name} lensLabel="Process Flow" exampleId="audiobook-distributor" lensId="process-flow" theme={fixture.theme}>
      <div className="canvas-wrap">
        <ProcessFlowCanvas graphData={graphData} theme={fixture.theme} />
      </div>
