...
export default function Page() {
  ...
  return (
    <LensShell exampleLabel={fixture.name} lensLabel="Swimlane" exampleId="audiobook-distributor" lensId="swimlane" theme={fixture.theme}>
      <div className="canvas-wrap">
        <SwimlaneCanvas swimlaneData={swimlaneData} theme={fixture.theme} />
      </div>
