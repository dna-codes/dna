...
export default function Page() {
  ...
  return (
    <LensShell exampleLabel={fixture.name} lensLabel="Runbook" exampleId="audiobook-distributor" lensId="runbook" theme={fixture.theme}>
      <RunbookCanvas graphData={graphData} theme={fixture.theme} />
