...
export default function Page() {
  ...
  return (
    <LensShell exampleLabel={fixture.name} lensLabel="Org Chart" exampleId="audiobook-distributor" lensId="org-chart" theme={fixture.theme}>
      <div className="canvas-wrap">
        <OrgChartCanvas graphData={graphData} theme={fixture.theme} />
      </div>
