...
import fixture from '../../../../../../examples/mass-torts-org/org-chart.json'
...
export default function Page() {
  ...
  return (
    <LensShell exampleLabel="Marshall Fire Justice" lensLabel="Responsibility Map" exampleId="mass-torts" lensId="responsibility-map">
