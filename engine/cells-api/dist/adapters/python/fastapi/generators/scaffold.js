...
exports.generateAlembicIni = generateAlembicIni;
exports.generateAlembicEnvPy = generateAlembicEnvPy;
exports.generateAlembicScriptMako = generateAlembicScriptMako;
exports.generateEnv = generateEnv;
exports.generateAppInit = generateAppInit;
...
function generatePyprojectToml(namespace) {
...
function generateAlembicScriptMako() {
    return `"""$\{message}
...
function generateEnv(port = 8000) {
    return `PORT=${port}
