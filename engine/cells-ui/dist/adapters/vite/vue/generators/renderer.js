...
exports.rendererDnaContext = rendererDnaContext;
exports.rendererDnaLoader = rendererDnaLoader;
exports.rendererUseApi = rendererUseApi;
exports.rendererApp = rendererApp;
exports.rendererAppSetup = rendererAppSetup;
exports.rendererLayoutShell = rendererLayoutShell;
exports.rendererSidebarLayout = rendererSidebarLayout;
exports.rendererFullWidthLayout = rendererFullWidthLayout;
exports.rendererThemeToggle = rendererThemeToggle;
exports.rendererPageView = rendererPageView;
exports.rendererBlockRenderer = rendererBlockRenderer;
...
exports.rendererActionButton = rendererActionButton;
...
function rendererSidebarLayout() {
    return `<template>
...
function rendererFullWidthLayout() {
    return `<template>
...
function rendererBlockRenderer() {
    return `<template>
