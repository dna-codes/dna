...
const generate = (ui, outputDir, _core, ctx) => {
    ...
    write(outputDir, 'env.d.ts', (0, scaffold_1.generateEnvDts)());
    ...
    write(outputDir, 'src/main.ts', (0, scaffold_1.generateMain)());
    // ── Renderer — Vue 3 SFC components, fetches DNA at runtime ────────────────
    write(outputDir, 'src/renderer/types.ts', (0, renderer_1.rendererTypes)());
    write(outputDir, 'src/renderer/context.ts', (0, renderer_1.rendererDnaContext)());
    write(outputDir, 'src/renderer/flags-context.ts', (0, renderer_1.rendererFlagsContext)());
    ...
    write(outputDir, 'src/renderer/useApi.ts', (0, renderer_1.rendererUseApi)());
    write(outputDir, 'src/renderer/App.vue', (0, renderer_1.rendererApp)());
    write(outputDir, 'src/renderer/LayoutShell.vue', (0, renderer_1.rendererLayoutShell)());
    write(outputDir, 'src/renderer/layouts/SidebarLayout.vue', (0, renderer_1.rendererSidebarLayout)());
    write(outputDir, 'src/renderer/layouts/FullWidthLayout.vue', (0, renderer_1.rendererFullWidthLayout)());
    write(outputDir, 'src/renderer/ThemeToggle.vue', (0, renderer_1.rendererThemeToggle)());
    write(outputDir, 'src/renderer/PageView.vue', (0, renderer_1.rendererPageView)());
    write(outputDir, 'src/renderer/BlockRenderer.vue', (0, renderer_1.rendererBlockRenderer)());
    write(outputDir, 'src/renderer/blocks/FormBlock.vue', (0, renderer_1.rendererFormBlock)());
    write(outputDir, 'src/renderer/blocks/TableBlock.vue', (0, renderer_1.rendererTableBlock)());
    write(outputDir, 'src/renderer/blocks/DetailBlock.vue', (0, renderer_1.rendererDetailBlock)());
    write(outputDir, 'src/renderer/blocks/ActionsBlock.vue', (0, renderer_1.rendererActionsBlock)());
    write(outputDir, 'src/renderer/blocks/ActionButton.vue', (0, renderer_1.rendererActionButton)());
    write(outputDir, 'src/renderer/blocks/EmptyStateBlock.vue', (0, renderer_1.rendererEmptyStateBlock)());
