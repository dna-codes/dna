...
describe('ui-cell adapter conformance', () => {
    ...
    beforeAll(() => {
        ...
        (0, run_1.run)(technicalPath, 'ui-cell', viteReactDir);
        (0, run_1.run)(technicalPath, 'vue-ui-cell', viteVueDir);
        (0, run_1.run)(technicalPath, 'ui-cell-next', nextReactDir);
    });
    afterAll(() => {
