...
exports.AGENT_HELP = exports.VIEWS_HELP = exports.DISCOVER_HELP = exports.VALIDATE_HELP = exports.RUN_HELP = exports.STATUS_HELP = exports.DOWN_HELP = exports.UP_HELP = exports.DEPLOY_HELP = exports.DEVELOP_HELP = exports.TECHNICAL_HELP = exports.PRODUCT_HELP = exports.OPERATIONAL_HELP = exports.ROOT_HELP = void 0;
exports.helpFor = helpFor;
exports.ROOT_HELP = `cba — unified CLI for the cell-based architecture lifecycle
...
`;
exports.OPERATIONAL_HELP = `cba operational — work with Operational DNA
...
`;
exports.PRODUCT_HELP = `cba product — work with Product DNA
...
FLAGS (vary by command)
  ...
  --json            Machine-readable output
`;
exports.TECHNICAL_HELP = `cba technical — work with Technical DNA
...
FLAGS (vary by command)
  ...
  --json            Machine-readable output
`;
exports.DEVELOP_HELP = `cba develop — run cells: DNA -> generated code
...
FLAGS
  ...
  --json            Machine-readable output
`;
exports.DEPLOY_HELP = `cba deploy — compose generated cells into a deployable topology
...
`;
exports.UP_HELP = `cba up — validate, develop, deploy, and launch the stack
...
`;
exports.DOWN_HELP = `cba down — tear down a deployed stack
...
`;
exports.STATUS_HELP = `cba status — show what's running for a deployed topology
...
`;
exports.RUN_HELP = `cba run — run generated output locally
...
`;
exports.VALIDATE_HELP = `cba validate — validate DNA across all layers
...
`;
exports.DISCOVER_HELP = `cba operational discover — stakeholder conversation -> draft DNA
...
`;
exports.VIEWS_HELP = `cba views — derive architecture graph JSON from technical DNA
...
`;
exports.AGENT_HELP = `cba agent — find and describe AGENTS.md contracts
...
function helpFor(command) {
    switch (command) {
        case 'operational':
            return exports.OPERATIONAL_HELP;
        case 'product':
            return exports.PRODUCT_HELP;
        case 'technical':
            return exports.TECHNICAL_HELP;
        case 'develop':
            return exports.DEVELOP_HELP;
        case 'deploy':
            return exports.DEPLOY_HELP;
        case 'up':
            return exports.UP_HELP;
        case 'down':
            return exports.DOWN_HELP;
        case 'status':
            return exports.STATUS_HELP;
        case 'run':
            return exports.RUN_HELP;
        case 'validate':
            return exports.VALIDATE_HELP;
        case 'discover':
            return exports.DISCOVER_HELP;
        case 'agent':
            return exports.AGENT_HELP;
        case 'views':
            return exports.VIEWS_HELP;
        default:
            return exports.ROOT_HELP;
    }
}
