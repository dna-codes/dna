...
Transform a ResourceGraph into a hierarchical org-chart view model and render it, using the `type` field to discriminate domains, groups, positions, and people.
## Requirements
