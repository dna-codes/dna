...
## Purpose
Defines how the type registry is governed across Build and Operate modes: the locked/open registry state is derived from the session mode (Operate ⇒ locked, Build ⇒ open), rather than from an independent boolean.
