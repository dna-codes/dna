...
Defines the `apps/graph-studio/` Next.js 15 application — its scaffold, routing, JointJS wiring, Neo4j connection contract, and TDD harness. This is the shell that all lenses (org chart, process flow, access control, etc.) are mounted inside.
